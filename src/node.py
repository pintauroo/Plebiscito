...
class node:
    ...
    def utility_function(self, avail_bw, avail_cpu, avail_gpu):        
        ...
        elif self.utility.value == Utility.LGF.value:
        ...
        elif self.utility.value == Utility.RANDOM.value:
            return self.id
        ...
        while True:
            try: 
                ...
                if all_finished and not self.already_finished: 
                    # print(f"Node {self.id} -- all_finished={all_finished} already_finished={self.already_finished}", flush=True)        
                    self.already_finished = True   
